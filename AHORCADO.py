...
AHORCADO = ['''
    ...
    =========''', '''
     ...
     / \  |
          |
    =========''']
palabras = 'aprenderpython datos juego python web condicionales variable curso false true if elif else while for loops valor funciones gratuito discord grupo3 informatorio programacion'.split()
